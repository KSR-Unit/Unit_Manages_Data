...
const CATEGORY_TITLES: Record<string, string> = {
  ...
  justice_fund: 'ขอเงินกองทุนยุติธรรม',
...
4. "trainings" (การอบรมและพัฒนาความรู้): หากพูดถึง รายงานการเข้าร่วมฝึกอบรมพัฒนาศักยภาพตนเองของผู้ไกล่เกลี่ย/เจ้าหน้าที่ (เช่น ไปอบรมที่กรม/กระทรวงจัด หรือสถาบันการศึกษาจัดอบรมให้), ไม่ใช่การเขียนคำเสนอขอเงินเพื่อจัดโครงการอบรมแก่ประชาชน
...
6. "justice_fund" (ขอเงินกองทุนยุติธรรม): หากพูดถึง การยื่นเสนอขอรับเงินสนับสนุนโครงการจัดอบรมกฎหมายแก่ประชาชนจากกองทุนยุติธรรม (กทย.4), เสนอโครงการโดยประธานศูนย์ไกล่เกลี่ย, หรือมีการพูดถึง "ขอเสนอโครงการ...เพื่อเสนอเงินกองทุนยุติธรรม"
