...
export default function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
  ...
  const configs: Record<string, CategoryConfig> = {
    ...
    ems_reports: {
      ...
      fields: [
        ...
        { 
          name: 'criminal_dispute_type', 
          label: 'ประเภทข้อพิพาททางอาญา', 
          type: 'select', 
          required: true, 
          conditional: { field: 'case_type', showIf: 'ทางอาญา' },
          options: [
            { value: 'มาตรา 272 ฐานเอาชื่อหรือยี่ห้อในทางการค้าของผู้อื่นมาใช้', label: 'มาตรา 272 ฐานเอาชื่อหรือยี่ห้อในทางการค้าของผู้อื่นมาใช้' },
            { value: 'มาตรา 309 วรรคแรก ฐานทำให้เสื่อมเสียเสรีภาพ', label: 'มาตรา 309 วรรคแรก ฐานทำให้เสื่อมเสียเสรีภาพ' },
            { value: 'มาตรา 310 วรรคแรก ฐานหน่วงเหนี่ยวกักขังผู้อื่น', label: 'มาตรา 310 วรรคแรก ฐานหน่วงเหนี่ยวกักขังผู้อื่น' },
            { value: 'มาตรา 311 วรรคแรก ฐานหน่วงเหนี่ยวกักขังผู้อื่นโดยประมาท', label: 'มาตรา 311 วรรคแรก ฐานหน่วงเหนี่ยวกักขังผู้อื่นโดยประมาท' },
            { value: 'มาตรา 322 ฐานเปิดเผยความลับในจดหมาย โทรเลขหรือเอกสาร', label: 'มาตรา 322 ฐานเปิดเผยความลับในจดหมาย โทรเลขหรือเอกสาร' },
            { value: 'มาตรา 323 ฐานเปิดเผยความลับของผู้อื่นที่รู้มาโดยหน้าที่', label: 'มาตรา 323 ฐานเปิดเผยความลับของผู้อื่นที่รู้มาโดยหน้าที่' },
            { value: 'มาตรา 324 ฐานเปิดเผยความลับในทางอุตสาหกรรมหรือวิทยาศาสตร์', label: 'มาตรา 324 ฐานเปิดเผยความลับในทางอุตสาหกรรมหรือวิทยาศาสตร์' },
            { value: 'มาตรา 326 ฐานหมิ่นประมาทคนเป็น', label: 'มาตรา 326 ฐานหมิ่นประมาทคนเป็น' },
            { value: 'มาตรา 327 ฐานหมิ่นประมาทคนตาย', label: 'มาตรา 327 ฐานหมิ่นประมาทคนตาย' },
            { value: 'มาตรา 328 ฐานหมิ่นประมาทด้วยการโฆษณา', label: 'มาตรา 328 ฐานหมิ่นประมาทด้วยการโฆษณา' },
            { value: 'มาตรา 341 ฐานฉ้อโกงธรรมดา', label: 'มาตรา 341 ฐานฉ้อโกงธรรมดา' },
            { value: 'มาตรา 342 ฐานฉ้อโกงประกอบด้วยเหตุพิเศษ', label: 'มาตรา 342 ฐานฉ้อโกงประกอบด้วยเหตุพิเศษ' },
            { value: 'มาตรา 344 ฐานฉ้อโกงแรงงานให้ไปทำงาน', label: 'มาตรา 344 ฐานฉ้อโกงแรงงานให้ไปทำงาน' },
            { value: 'มาตรา 345 ฐานสั่งซื้ออาหารหรือเข้าอยู่ในโรงแรมโดยไม่มีเงิน', label: 'มาตรา 345 ฐานสั่งซื้ออาหารหรือเข้าอยู่ในโรงแรมโดยไม่มีเงิน' },
            { value: 'มาตรา 346 ฐานชักจูงให้เด็กเบาปัญญาขายของโดยเสียเปรียบ', label: 'มาตรา 346 ฐานชักจูงให้เด็กเบาปัญญาขายของโดยเสียเปรียบ' },
            { value: 'มาตรา 347 ฐานฉ้อโกงในเรื่องประกันวินาศภัย', label: 'มาตรา 347 ฐานฉ้อโกงในเรื่องประกันวินาศภัย' },
            { value: 'มาตรา 349 ฐานฉ้อโกงเจ้าหนี้ผู้รับจำนำ', label: 'มาตรา 349 ฐานฉ้อโกงเจ้าหนี้ผู้รับจำนำ' },
            { value: 'มาตรา 350 ฐานฉ้อโกงเจ้าหนี้ธรรมดา', label: 'มาตรา 350 ฐานฉ้อโกงเจ้าหนี้ธรรมดา' },
            { value: 'มาตรา 352 ฐานยักยอกทรัพย์ธรรมดา', label: 'มาตรา 352 ฐานยักยอกทรัพย์ธรรมดา' },
            { value: 'มาตรา 353 ฐานยักยอกทรัพย์ในฐานะเป็นผู้จัดการทรัพย์แทนเขา', label: 'มาตรา 353 ฐานยักยอกทรัพย์ในฐานะเป็นผู้จัดการทรัพย์แทนเขา' },
            { value: 'มาตรา 354 ฐานยักยอกทรัพย์ในฐานะเป็นผู้จัดการทรัพย์ตามคำสั่งศาล', label: 'มาตรา 354 ฐานยักยอกทรัพย์ในฐานะเป็นผู้จัดการทรัพย์ตามคำสั่งศาล' },
            { value: 'มาตรา 355 ฐานยักยอกทรัพย์เก็บตก', label: 'มาตรา 355 ฐานยักยอกทรัพย์เก็บตก' },
            { value: 'มาตรา 358 ฐานทำให้เสียทรัพย์ธรรมดา', label: 'มาตรา 358 ฐานทำให้เสียทรัพย์ธรรมดา' },
            { value: 'มาตรา 359 ฐานทำให้เสียทรัพย์ชนิดพิเศษ', label: 'มาตรา 359 ฐานทำให้เสียทรัพย์ชนิดพิเศษ' },
            { value: 'มาตรา 362 ฐานบุกรุกธรรมดา', label: 'มาตรา 362 ฐานบุกรุกธรรมดา' },
            { value: 'มาตรา 363 ฐานบุกรุกโดยย้ายเครื่องหมายอสังหาริมทรัพย์', label: 'มาตรา 363 ฐานบุกรุกโดยย้ายเครื่องหมายอสังหาริมทรัพย์' },
            { value: 'มาตรา 364 ฐานเข้าไปซ่อนตัวในเคหะหรืออาคารของผู้อื่น', label: 'มาตรา 364 ฐานเข้าไปซ่อนตัวในเคหะหรืออาคารของผู้อื่น' },
            { value: 'มาตรา 390 ประมาทเป็นเหตุให้บุคคลอื่นได้รับอันตรายแก่กายและจิตใจ', label: 'มาตรา 390 ประมาทเป็นเหตุให้บุคคลอื่นได้รับอันตรายแก่กายและจิตใจ' },
            { value: 'มาตรา 391 ทำร้ายร่างกายผู้อื่นไม่ถึงกับเป็นเหตุให้เกิดอันตรายแก่กายและจิตใจ', label: 'มาตรา 391 ทำร้ายร่างกายผู้อื่นไม่ถึงกับเป็นเหตุให้เกิดอันตรายแก่กายและจิตใจ' },
            { value: 'มาตรา 392 ทำให้ผู้อื่นเกิดความกลัวหรือตกใจโดยการขู่เข็ญ', label: 'มาตรา 392 ทำให้ผู้อื่นเกิดความกลัวหรือตกใจโดยการขู่เข็ญ' },
            { value: 'มาตรา 393 ดูหมิ่นผู้อื่นซึ่งหน้าหรือด้วยการโฆษณา', label: 'มาตรา 393 ดูหมิ่นผู้อื่นซึ่งหน้าหรือด้วยการโฆษณา' },
            { value: 'มาตรา 394 ไล่ต้อนหรือทำสัตว์เข้าสวนไร่นาของผู้อื่นที่แต่งดินไว้ เพาะพันธุ์ไว้ หรือมีพืชพันธุ์ หรือผลผลิตอยู่', label: 'มาตรา 394 ไล่ต้อนหรือทำสัตว์เข้าสวนไร่นาของผู้อื่นที่แต่งดินไว้ เพาะพันธุ์ไว้ หรือมีพืชพันธุ์ หรือผลผลิตอยู่' },
            { value: 'มาตรา 395 ปล่อยปละละเลยให้สัตว์เข้าในสวนไร่นาของผู้อื่นที่แต่งดินไว้ เพาะพันธุ์ไว้ หรือมีพืชพันธุ์ หรือผลผลิตอยู่', label: 'มาตรา 395 ปล่อยปละละเลยให้สัตว์เข้าในสวนไร่นาของผู้อื่นที่แต่งดินไว้ เพาะพันธุ์ไว้ หรือมีพืชพันธุ์ หรือผลผลิตอยู่' },
            { value: 'มาตรา 397 กระทำด้วยประการใดๆ อันเป็นการรังแกข่มเหงผู้อื่น หรือกระทำให้ผู้อื่นได้รับความอับอายหรือเดือดร้อนรำคาญ', label: 'มาตรา 397 กระทำด้วยประการใดๆ อันเป็นการรังแกข่มเหงผู้อื่น หรือกระทำให้ผู้อื่นได้รับความอับอายหรือเดือดร้อนรำคาญ' },
            { value: 'ความผิดฐานละเมิดงานอันมีลิขสิทธิ์ เป็นความผิดอันยอมความได้', label: 'ความผิดฐานละเมิดงานอันมีลิขสิทธิ์ เป็นความผิดอันยอมความได้' },
            { value: 'ฐานกระทำความรุนแรงในครอบครัว (มาตรา 4)', label: 'ฐานกระทำความรุนแรงในครอบครัว (มาตรา 4)' },
            { value: 'ฐานใช้ผู้รับบริการเป็นส่วนหนึ่งของการทดลองในงานวิจัยโดยไม่ได้รับความยินยอม (มาตรา 9)', label: 'ฐานใช้ผู้รับบริการเป็นส่วนหนึ่งของการทดลองในงานวิจัยโดยไม่ได้รับความยินยอม (มาตรา 9)' },
            { value: 'ฐานนำเข้าสู่ระบบคอมพิวเตอร์ซึ่งข้อมูลที่ปรากฏเป็นภาพโดยประการที่น่าจะทำให้ ผู้อื่นเสียชื่อเสียง ถูกดูหมิ่น เกลียดชัง หรือได้รับความอับอาย (มาตรา 16)', label: 'ฐานนำเข้าสู่ระบบคอมพิวเตอร์ซึ่งข้อมูลที่ปรากฏเป็นภาพโดยประการที่น่าจะทำให้ ผู้อื่นเสียชื่อเสียง ถูกดูหมิ่น เกลียดชัง หรือได้รับความอับอาย (มาตรา 16)' },
            { value: 'ฐานเปิดเผยข้อมูลด้านสุขภาพของ บุคคล (มาตรา 7)', label: 'ฐานเปิดเผยข้อมูลด้านสุขภาพของ บุคคล (มาตรา 7)' },
            { value: 'ฐานเปิดเผยความลับทางการค้า ของผู้อื่น (มาตรา 33)', label: 'ฐานเปิดเผยความลับทางการค้า ของผู้อื่น (มาตรา 33)' },
            { value: 'ฐานออกเช็คโดย เจตนาที่จะไม่ให้มีการใช้เงิน (มาตรา 4)', label: 'ฐานออกเช็คโดย เจตนาที่จะไม่ให้มีการใช้เงิน (มาตรา 4)' },
            { value: 'ฐานโอน จำนอง หรือจำนำทรัพย์ที่ได้กรรมสิทธิ์มาโดยใช้เงินกู้จากธนาคารและ เอกสารระบุการห้ามไว้ (มาตรา 32)', label: 'ฐานโอน จำนอง หรือจำนำทรัพย์ที่ได้กรรมสิทธิ์มาโดยใช้เงินกู้จากธนาคารและ เอกสารระบุการห้ามไว้ (มาตรา 32)' },
            { value: 'ความผิดลหุโทษอื่นที่ไม่กระทบต่อส่วนรวม ตามที่กำหนดในพระราชกฤษฎีกา', label: 'ความผิดลหุโทษอื่นที่ไม่กระทบต่อส่วนรวม ตามที่กำหนดในพระราชกฤษฎีกา' }
          ]
        },
        ...
        { name: 'end_date_mediation', label: 'วันที่ไกล่เกลี่ยสำเร็จ', type: 'date' },
  ...
  const handleOpenAddModal = () => {
    ...
    if (category === 'ems_reports') {
      initialForm.case_type = '';
      initialForm.civil_dispute_type = '';
      initialForm.criminal_dispute_type = '';
    }
  ...
  const handleOpenEditModal = (item: any) => {
    ...
    if (category === 'ems_reports' && item.case_type) {
      if (item.case_type.startsWith('ทางแพ่ง (')) {
        ...
        initialForm.criminal_dispute_type = '';
      } else if (item.case_type.startsWith('ทางอาญา (')) {
        const criminalType = item.case_type.replace('ทางอาญา (', '').replace(')', '');
        initialForm.case_type = 'ทางอาญา';
        initialForm.civil_dispute_type = '';
        initialForm.criminal_dispute_type = criminalType;
        ...
        initialForm.case_type = 'ทางอาญา';
        initialForm.civil_dispute_type = '';
        initialForm.criminal_dispute_type = 'มาตรา 272 ฐานเอาชื่อหรือยี่ห้อในทางการค้าของผู้อื่นมาใช้';
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (category === 'ems_reports') {
        // Combine case_type and civil/criminal dispute types into case_type column
        if (payload.case_type === 'ทางแพ่ง') {
          payload.case_type = `ทางแพ่ง (${payload.civil_dispute_type || 'การชำระหนี้'})`;
        } else if (payload.case_type === 'ทางอาญา') {
          payload.case_type = `ทางอาญา (${payload.criminal_dispute_type || 'มาตรา 272 ฐานเอาชื่อหรือยี่ห้อในทางการค้าของผู้อื่นมาใช้'})`;
        }
        // Remove virtual fields so they don't cause Supabase error
        delete payload.civil_dispute_type;
        delete payload.criminal_dispute_type;
      }
